<div class="comment__container opened" id="first-comment">
    <div class="comment__card">
        <div class="comment__title">
            <div class="card-image image-comment"></div>
            <div class="name commenter-name">User 1</div>
        </div>
        <p>
    ...
    <div class="comment__container" dataset="first-comment" id="first-reply">
        <div class="comment__card">
            <h5 class="comment__title">The first reply</h5>
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Pariatur, reprehenderit a inventore dolorem explicabo in quibusdam eum voluptatum facere nemo nam et commodi fugit quas accusantium temporibus corporis quod natus.
            </p>
            <div class="cooment__card-footer">
        ...
        <div class="comment__container" dataset="first-reply" id="first-first-reply">
            <div class="comment__card">
                <h5 class="comment__title">The first reply to the first reply to the first comment</h5>
                <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Pariatur, reprehenderit a inventore dolorem explicabo in quibusdam eum voluptatum facere nemo nam et commodi fugit quas accusantium temporibus corporis quod natus.
                </p>
                <div class="cooment__card-footer">
    ...
    <div class="comment__container" dataset="first-comment" id="second-reply">
        <div class="comment__card">
            <h5 class="comment__title">The second reply</h5>
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Pariatur, reprehenderit a inventore dolorem explicabo in quibusdam eum voluptatum facere nemo nam et commodi fugit quas accusantium temporibus corporis quod natus.
            </p>
            <div class="cooment__card-footer">
