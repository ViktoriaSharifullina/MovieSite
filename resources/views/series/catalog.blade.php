    ...
    <div class="col-left">
        <div class="left-container">
            <div class="left-menu-container">
                <form action="{{ route('tv.catalogAdvanced') }}" method="GET" id="formFilter">
...
<div class="col-right">
    <div class="right-container">
        <div class="search-container">
            <form id="search-form" action="{{ route('tv.search') }}" method="GET">
        ...
        <div class="movie-catalog-container">
            <div class="movie-list-container">
                ...
                <div class="movie-list">
                    @if(!empty($tvData))
                    @foreach($tvData as $movie)
                    <div class="movie-list-item">
                        <a href="{{ route('tv.about', $movie['id']) }}">
                    ...
                    @endforeach
                    @else
                    <div class="no-movies-found">No tv found.</div>
                    @endif
                </div>
            </div>
        </div>
